                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="card course-card h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="card-text">Learn to build complete web applications from front-end to back-end.</p>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="card course-card h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="card-text">Build beautiful and functional native mobile apps for iOS and Android.</p>
                            <a href="course-details.html" class="btn btn-primary mt-auto">Enroll Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="card course-card h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="card-text">Improve software development speed and quality with DevOps principles.</p>
                            <a href="course-details.html" class="btn btn-primary mt-auto">Enroll Now</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="testimonial-card h-100">
                        ...
                        <p class="testimonial-text">"The full-stack course was a game-changer for my career. The project-based approach made learning effective and fun!"</p>
                        <div class="testimonial-author">
                            <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Student" class="rounded-circle">
                            <div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="testimonial-card h-100">
                        <i class="bi bi-quote display-4 text-primary"></i>
                        <p class="testimonial-text">"I went from zero coding knowledge to building my own mobile app. The instructors are incredibly supportive."</p>
                        <div class="testimonial-author">
                            <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Student" class="rounded-circle">
                            <div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="testimonial-card h-100">
                        <i class="bi bi-quote display-4 text-primary"></i>
                        <p class="testimonial-text">"The data science course helped me land my dream job. The curriculum is top-notch and the instructors are amazing."</p>
                        <div class="testimonial-author">
                            <img src="https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Student" class="rounded-circle">
                            <div>
